...
def calculate_tag_counts_all_sites():
    ...
    OTIMIZADO: Usa Pipes para não lotar o disco.
    """
    ...
    for site_alias, site_file in SITES.items():
        ...
        try:
            ...
            # Comando para extrair para o stdout (-so)
            cmd = ["7z", "e", archive_path, posts_filename, "-so"]
            
            # Iniciando o pipe
            process = subprocess.Popen(cmd, stdout=subprocess.PIPE, stderr=subprocess.PIPE)

            # iterparse lê diretamente do stream do processo
            ...
            for _, elem in context:
                ...
                # Crucial para não estourar a RAM
                elem.clear()
...
def calculate_a_and_c_all_sites():
    """
    Mantém o comportamento original: lê o CSV gerado pelo script anterior.
    """
    ...
    # Carrega o CSV que agora está otimizado (sem a coluna body)
...
def calculate_heuristics_and_filter(df_counts, df_a, c):
    """
    Mantém o comportamento original de cálculo de H1 e H2.
    """
